      ...
      $(window).on('scroll', function() {
        ...
        if (more_posts_url && $(window).scrollTop() > $(document).height() - $(window).height() - 60) {
          ...
          $.ajax({
            url: more_posts_url,
            success: function(data) {
              return $(".homeinfinitediv").append(data);
            }
          });
        }
        if (!more_posts_url) {
...
(function() {
  $(function() {
    return $('.flash').delay(2500).fadeOut();
  });
...
(function() {
  $(function() {
    return $('.midhdglyphnil').click(function() {
      return alert("Your account has not been provisioned to make a hall. Please verify your account.");
    });
  });
