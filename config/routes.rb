SampleApp::Application.routes.draw do
  ...
  match '/signup',  to: 'static_pages#welcome',            via: 'get'
  match '/signin',  to: 'static_pages#welcome',         via: 'get'
  match '/signout', to: 'sessions#destroy',     via: 'delete'
  match '/privacy',    to: 'static_pages#welcome',    via: 'get'
  match '/about_us',    to: 'static_pages#welcome',    via: 'get'
  match '/support', to: 'static_pages#welcome', via: 'get'
  match '/youth',    to: 'static_pages#youth',    via: 'get'
  match '/terms', to: 'static_pages#terms', via: 'get' 
  match '/guide', to: 'static_pages#welcome', via: 'get' 
